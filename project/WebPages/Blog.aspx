<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Blog.aspx.cs" Inherits="Project.Pages_inside.Blog" %>
...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
    <div class="container">
      <a class="navbar-brand" href="../index.html">Incredible India</a>
      ...
      <div class="row">
        <div class="col-lg-8 col-md-10 mx-auto">
          <div class="site-heading">
            ...
            <span class="subheading">Experience what other travellers feel</span>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-8 col-md-10 mx-auto">
          ...
          <p class="copyright text-muted">Copyright &copy; Incredible India</p>
        </div>
      </div>
    </div>
  </footer>
