<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="About.aspx.cs" Inherits="Project.Pages_inside.vendor.About" %>
...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    <div class="container">
      <a class="navbar-brand js-scroll-trigger" href="#page-top">Incredible India</a>
      ...
      <div class="collapse navbar-collapse " id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="Blog.aspx">Blog</a>
          </li>
          <li class="nav-item">
      ...
      <div class="row">
        <div class="col-lg-8 mx-auto">
          <h2>Contact us</h2>
            ...
            <p class="lead">Email : somebody@something.com</p>
        </div>
      </div>
    </div>
  </section>
